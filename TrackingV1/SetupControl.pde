...
void save(int v) {
  ...
  for (int i = 0; i< 4; i++) {
    json.dbox[0].handlesCoor[i].setFloat("x", dbox0.getHandles()[i].getX());
    json.dbox[0].handlesCoor[i].setFloat("y", dbox0.getHandles()[i].getY());
    json.dbox[1].handlesCoor[i].setFloat("x", dbox1.getHandles()[i].getX());
    json.dbox[1].handlesCoor[i].setFloat("y", dbox1.getHandles()[i].getY());
  }
