...
NetAddress myRemoteLocation; // ip adresse for osc communication
...
void setup() {
  ...
  // INPUT : Start oscP5, listening for incoming messages at port 12000
  oscP5 = new OscP5(this, 12000);
  // OUTPUT : NetAdress : ip adress and port number for sending data
  myRemoteLocation = new NetAddress("192.168.2.117", 12000);
